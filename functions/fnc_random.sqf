...
if(isServer) then {
	...
	switch (_type) do {
		case "boog": { 
			...
			_gun2 = ["pas_scar_std_USA", "rhs_mag_20Rnd_SCAR_762x51_m80_ball", "rhsusf_acc_ACOG_USMC"];
		...
		case "covert": { 
			_uniforms = ["tshirt_7500","tshirt_bulldozer","tshirt_freedom","tshirt_pagreen","shirt_thugbob_2","tshirt_classictruck_1","tshirt_doggologistics","shirt_cFlOutdoor_1","tshirt_goose","tshirt_pahivis_green","tshirt_pahivis","tshirt_pasand","tshirt_gunschizo","tshirt_talkingsticksand","shirt_tanBlank_1","shirt_thugbob_1","shirt_appealtoheaven","bigigloo_blue","thisismyboogshirt_1","shirt_fofo","govgetoutree_green","govgetoutree_yellow","nottoday_1","oif_vet_tan_1","taxfraud_1"];
